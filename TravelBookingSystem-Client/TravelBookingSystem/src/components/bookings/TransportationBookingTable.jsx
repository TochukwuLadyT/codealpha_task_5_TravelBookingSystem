...
const TransportationBookingTable = ({bookingInfo, handleBookingCancellation}) => {
				...
				<tbody className="text-center">
					{filteredBookings.map((booking, index) => (
						<tr key={booking.id}>
                            ...
                            <td>{booking.travel.transportationName}</td>
							<td>{booking.travel.id}</td>
							<td>{booking.travel.transportationType}</td>
...
export default TransportationBookingTable
