...
import { bookHotelRoom, getTravelById } from '../utils/ApiFunctions'
import HotelBookingSummary from "./HotelBookingSummary";
	...
	const getRoomPriceById = async (travelId) => {
		try {
			const response = await getTravelById(travelId)
			setRoomPrice(response.roomPrice)
		} catch (error) {
	...
	const handleFormSubmit = async () => {
		try {
			const confirmationCode = await bookHotelRoom(travelId, booking)
			setIsSubmitted(true)
